...
- (void) setupReader
{
    ...
    //NSURL *assetURL = self.mediaPickerController.songURL;
...
{
    Streamer *appStreamer = (__bridge Streamer *) inUserData;
    [appStreamer myCallback:inUserData inAudioQueue:inAQ audioQueueBufferRef:inCompleteAQBuffer];
